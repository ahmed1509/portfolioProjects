package com.sg.vendingmachinespringmvcproject.io;
...
public class UserIOConsoleImpl implements UserIO {
    ...
    /*public String LocalDate(String prompt){
        System.out.print(prompt);
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("mm/dd/yy");
        LocalDate Id = LocalDate.parse()
    ...
    public BigDecimal readBigDecimal(String prompt) {
        print(prompt);
        BigDecimal userReturn = null;
        boolean isItValid = false;
        while (!isItValid) {
            try {

                String toCheck = reader.nextLine();
                userReturn = new BigDecimal(toCheck);
                isItValid = true;
            } catch (NumberFormatException e) {
                System.out.println("Please Enter a valid Number");
